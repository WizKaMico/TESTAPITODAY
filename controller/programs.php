...
$sql = "SELECT * FROM program_management";
$stmt = $db->query($sql);
...
<body>
    ...
    <script>
        var columnDefs = [
            ...
            { headerName: "Program Start", field: "start",  filter: true, resizable: true },
            { headerName: "Program End", field: "end",  filter: true, resizable: true },
            { headerName: "Place", field: "place",  filter: true, resizable: true },
